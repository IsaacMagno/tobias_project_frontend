...
const ChampionPage = () => {
  ...
  return (
    <div className="bg-hero flex min-h-screen bg-no-repeat bg-cover bg-center bg-fixed bg-opacity-90 gap-3">
      <NavSideBar />
      <div className="">
        ...
        <div className="flex justify-between mt-8">
          ...
          <div className="bg-gray-500 opacity-40 text-xl font-light text-center max-w-2xl rounded-r flex items-center">
            <p className="">
              ...
              repellat accusantium! Necessitatibus aspernatur voluptas adipisci
              alias, odio nemo. Aperiam qui rerum consequatur maxime
